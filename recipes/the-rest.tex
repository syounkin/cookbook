...
%% Combine ingredients and toast in a dry skillet on medium heat for 5-6 minutes, or ``until aromatic and golden brown.''  Let cool and grind to a fine powder. 
%% \freeform The recipe called for 4 cardamom pods, but we only had powder.  The recipe also called for 5 dried curry leaves, but we used 1 tsp of a ground curry leaf powder, which contained many ingredients other than curry leaves.  We found that the cinnamon and cloves didn't grind completely.\\
...
%% Combine ingredients and toast in a dry skillet, moving constantly, on medium heat for about 5 minutes, or ``until aromatic and golden brown.''  Let cool and grind to a fine powder. 
%% \freeform 
%% \end{recipe}
%% %================================================================
%% %================================================================
