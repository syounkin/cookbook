...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=0.32\textwidth]{\string~/Dropbox/cookbook/figures/hariov60.jpg}
\hspace{0.1\textwidth}
\includegraphics[height=0.32\textwidth]{\string~/Dropbox/cookbook/figures/hariov60fromtopcropped.jpg}
\end{center}
\caption*{The ``Dripper'' }
\end{figure}
